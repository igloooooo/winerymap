...
public class PullRefreshListView extends ListView implements OnScrollListener {
	...
	private void initView() {
		...
		headView = (LinearLayout) mInflater.inflate(R.layout.wm_igt_listview_headview, null);
		footView = (LinearLayout) mInflater.inflate(R.layout.wm_igt_listview_footview, null);
