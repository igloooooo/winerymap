...
public class GDActionBarHost extends LinearLayout {
    ...
    private GDActionBar mGDTActionBar;
    ...
    protected void onFinishInflate() {
        ...
        mGDTActionBar = (GDActionBar) findViewById(R.id.gd_action_bar);
        if (mGDTActionBar == null || !(mGDTActionBar instanceof GDActionBar)) {
