...
public class GDActionBar extends LinearLayout {
    ...
    /**
     * Default identifier applied to a newly added {@link GDActionBarItem}s.
     * 
     * @deprecated Adding items to the ActionBar with no identifier does not
     *             allow client to retrieve a particular {@link GDActionBarItem}
     *             safely. In order to avoid this problem, {@link GDActionBarItem}
     *             s should be added with methods that requires explicit
     *             identifiers such as
     *             {@link GDActionBar#addItem(GDActionBarItem, int)} or
     *             {@link GDActionBar#addItem(GDActionBarItem.Type, int)}
     */
    ...
    public enum Type {
         ...
         * {@link GDActionBarItem}s on the right. The space that left between is
         ...
         * and optional {@link GDActionBarItem}s on the right. Please note the
        ...
        /**
         * ActionBar layout will contain optional {@link GDActionBarItem}s on the
     ...
     * interacting with an {@link GDActionBar}.
     * 
     * @author Cyril Mottier
     */
    public interface OnActionBarListener {
         ...
         *            first {@link GDActionBarItem} (the leftmost item) and so on.
         */
    ...
    /**
     * @param title The title to set to this {@link GDActionBar}
     */
