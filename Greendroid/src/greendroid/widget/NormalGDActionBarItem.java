 ...
 * {@link NormalGDActionBarItem} is a simple {@link GDActionBarItem} containing a
 * single icon.
 * 
 * @author Cyril Mottier
 */
public class NormalGDActionBarItem extends GDActionBarItem
{

    @Override
    protected View createItemView() {
        return LayoutInflater.from(mContext).inflate(R.layout.gd_action_bar_item_base, mGDTActionBar, false);
    }
