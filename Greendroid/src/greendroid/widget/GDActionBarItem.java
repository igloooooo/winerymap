...
public abstract class GDActionBarItem
{
    ...
    /**
     * The Type specifies a large set of pre-defined {@link GDActionBarItem}s that
     * may be added to an {@link GDActionBar}.
     * 
     * @author Cyril Mottier
     */
    public enum Type {
    ...
    static GDActionBarItem createWithType(GDActionBar GDActionBar, GDActionBarItem.Type type) {
        ...
        switch (type) {
            ...
            case Refresh:
                return GDActionBar.newActionBarItem(LoaderGDActionBarItem.class)
                        .setDrawable(new ActionBarDrawable(GDActionBar.getContext(), R.drawable.gd_action_bar_refresh))
        ...
        final Drawable d = new ActionBarDrawable(GDActionBar.getContext(), drawableId);

        return GDActionBar.newActionBarItem(NormalGDActionBarItem.class).setDrawable(d).setContentDescription(descriptionId);
    }
